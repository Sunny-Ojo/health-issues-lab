...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <section id="cta-1" class="section-padding">
    ...
    <div class="row justify-content-center">
        ...
        <h1 class=" text-center text-danger">Medical Issues Result for {{$data['Name']}}</h1>
        <div class="div">
        <h3><b>Description:</b> <span style="font-size:18px">{{$data['Description']}}</span></h3>
        <h3><b>Medical Conditions:</b> <span style="font-size:18px">{{$data['MedicalCondition']}}</span></h3>
        <h3><b>Possible Symptoms:</b> <span style="font-size:18px">{{$data['PossibleSymptoms']}}.</span></h3>
        <h3><b>Medical Professional Name:</b> <span style="font-size:18px">{{$data['ProfName']}}.</span></h3>
        <h3><b>Treatment Description:</b> <span style="font-size:18px">{{$data['TreatmentDescription']}}</span></h3>
        <br><br>
        <h2>Please Stay Safe...</h2>
         <a href="/health/issues#issues" class="btn btn-success search_more">Search For more Medical Issues</a>
        </div>
        </div>
    </div>
    </div>
